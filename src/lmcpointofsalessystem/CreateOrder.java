                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(jLabel20)
                                    .addComponent(btnClearRow, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(btnProceed, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
...
ArrayList<Float> ll = new ArrayList<Float>();
    ...
    void genpdf(){
        ...
        if(totalorders.equals("0")){
            ...
            "Time",
            "Total"};
        Object[][] tableData = new Object[nRow][nCol];// data galing sa rows and columns ng table
        ...
        try {
            ...
            PdfWriter.getInstance(document,new FileOutputStream("Orders.pdf")); //pangalan ng pdf file
            document.open();
            PdfPTable pdfTable = new PdfPTable(10); // pdf table columns dapat sakto
            ...
            //set column widths
            int[] columnWidths = new int[] {1320, 1380, 1390, 1400, 1410, 1420, 1440, 1450, 1490, 1500}; // column widths
