 ...
 * @author JohnReinel
 */
public class PDFStocksEmployee {
    Connection con;
        ...
        try  {
          ...
          float [] widths2=new float[colNums];
            ...
            try {
                ...
                Logger.getLogger(PDFStocksEmployee.class.getName()).log(Level.SEVERE, null, ex);
            }
...
public void connectToDatabase() {
    ...
    public PDFStocksEmployee (String tblName) throws IOException{
        try {
